...
def add_acceptance(doc):
    ...
    checks = [
        ...
        "Бейдж `1С: X/Y совпало` означает, что X строк сверки совпали из Y найденных строк ERP ↔ 1С; `Остаток` считается как оплата минус возмещаемые и невозмещаемые расходы.",
