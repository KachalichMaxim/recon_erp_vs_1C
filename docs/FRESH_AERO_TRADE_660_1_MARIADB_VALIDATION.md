...
Проверка нужна как контрольная модель для PHP-страницы ERP: экран и XLSX должны строиться из MariaDB и существующего обмена с 1С, а не из внешнего аналитического файла.
